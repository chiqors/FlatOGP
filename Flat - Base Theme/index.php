...
?>
	...
	<table style="width: 400px;" align="center">
	  ...
	  <tr>
		<td>
		<div style="background-color:#fff; overflow:hidden;text-align:left; font-size:0.9em;">
		<div style="text-align: center; text-transform: uppercase; font-size: 20px; padding: 10px 25px; background: rgb(68, 143, 198) none repeat scroll 0% 0%; color: rgb(255, 255, 255);" class="login_title"><?php print_lang('login_title'); ?></div>
		<br>
		<form action="index.php<?php echo preg_replace( "/\&amp;/", "?", $lang_switch ); ?>" name="login_form" method="post">
		<table align="center">
			<tbody>
			<tr>
				<td style="padding: 25px 20px 10px;"><input style="width: 320px; height: 25px; border: 1px solid rgb(204, 204, 204); padding: 3px;" name="ulogin" id="ulogin" value="" size="20" placeholder="<?php print_lang('login'); ?>" type="text"></td>
			</tr>
			<tr>
				<td style="padding: 5px 20px;"><input name="upassword" value="" size="20" style="width: 320px; height: 25px; border: 1px solid rgb(204, 204, 204); padding: 3px;" placeholder="<?php print_lang('password'); ?>" type="password"></td>
			</tr>
			<?php 
				if($settings['recaptcha_use_login'] == "1" && !empty($settings['recaptcha_site_key']) && !empty($settings['recaptcha_secret_key'])){
			?>
			<tr>
				<td><?php print_lang('solve_captcha'); ?>:<br>
			...
			?>
			<tr>
				<td style="padding: 20px 25px 10px;"><span style="float: left;"><?php print_lang('lang'); ?>: <?php echo $lang_sel; ?></span><span style="float: right;"><a href="?m=lostpwd<?php echo $lang_switch; ?>"><?php print_lang('lost_passwd'); ?></a></span></td>
			</tr>
			<tr style="text-align: center;">
				<td><input name="login" value="<?php print_lang('login_button'); ?>" class="login_button" type="submit"></td>
			</tr>
		</tbody>
		</table>
		</form>
	...
	?>
	<script src="themes/Flat/js/TweenLite.min.js"></script>
	<script src="themes/Flat/js/EasePack.min.js"></script>
	<script src="themes/Flat/js/animate.js"></script>
	<div class="clear"></div>	
	%botbody%
	%bottom%
<?php
