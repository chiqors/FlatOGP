...
?>
	...
	<table style="width: 400px;" align="center">
	  ...
	  <tr>
		...
		<div style="text-align: center; text-transform: uppercase; font-size: 20px; padding: 10px 25px; background: rgb(68, 143, 198) none repeat scroll 0% 0%; color: rgb(255, 255, 255);"><?php print_lang('login_title'); ?></div>
		<br>
